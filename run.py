...
def run_langcost_report(source_run_id: Optional[str] = None) -> int:
    """
    Read a completed langcost full-run JSONL and write results/syntese/language_cost_data.md.
    ...
    report_path = syntese_dir / "language_cost_data.md"
...
def main() -> None:
    ...
    parser.add_argument(
        ...
        action="store_true",
        help=(
            "Generate results/syntese/language_cost_data.md from a completed "
